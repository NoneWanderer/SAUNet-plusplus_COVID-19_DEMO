...
def _atk(models, coeff, X, y, epsilon, niters, alpha=0.01, use_mean=False):
    ...
    for i in range(niters): 
        ...
        for m, r in zip(models, coeff):
            loss = crit(infer(m, X_pgd), y.long())
...
def gen_samples_ensemble(name, dataset, models, coeff, epsilon=16/255, niters=20, alpha=1/255, _atk=_atk, use_mean=True, bs=8):
    out_dir = '../data_attacks/'+name+'/images2'
